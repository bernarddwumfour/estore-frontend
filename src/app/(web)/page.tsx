...
function Hero2() {
  return (
    ...
    <section className="relative py-36 md:py-64 bg-cover bg-center" >
      ...
      <div className="relative z-[2] max-w-4xl mx-auto px-6 h-full flex flex-col justify-center items-center text-center text-white">
        <h1 className="text-2xl md:text-4xl md:text-6xl font-extrabold mb-4">Authentic Apple Products.  Designed for You.</h1>
        <p className="text-base md:text-xl mb-8 bg-white/20  backdrop-blur-md p-3 my-2">iPhone, MacBook, iPad, Apple Watch, AirPods — everything Apple, all in one place.</p>
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:items-center justify-between md:gap-8">
          <div>
            <div className="max-w-prose md:max-w-none space-y-6">
              ...
              <p className="mt-4 text-sm md:text-base text-pretty text-gray-700 leading-8">
    ...
    <section className="relative py-24 bg-cover bg-center" >
      ...
      <div className="mx-auto container">
        <div className="py-8 px-4">
          <h1 className="font-bebas-neue uppercase text-2xl md:text-3xl font-bold mb-4">Best Sellers</h1>
  ...
  return (
    <section className="py-24 bg-gray-50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="py-6">
          <h1 className="font-bebas-neue uppercase text-2xl md:text-3xl font-bold mb-4">Shop by Category</h1>
...
function Testimonials() {
  return (
    <section className="py-24 bg-gray-50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="py-6">
          <h1 className="font-bebas-neue uppercase text-2xl md:text-3xl font-bold mb-4">TESTIMONIAL</h1>
