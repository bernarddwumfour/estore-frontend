    ...
    return (
      <div className="min-h-screen bg-gray-50 py-32">
        <div className="container mx-auto px-4">
          <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-8 ">Terms & Conditions</h1>
          <div className="bg-white border border-gray-100 rounded-lg p-4 md:p-8 prose prose-lg max-w-none">
            ...
            <h2 className="text-xl font-bold text-gray-900 mt-10 mb-4">Use of Our Site</h2>
            ...
            <h2 className="text-xl font-bold text-gray-900 mt-10 mb-4">Product Information</h2>
            <p className="mb-6">
