      ...
      <div className="min-h-screen bg-gray-50 py-32">
        <div className="container mx-auto px-4">
          ...
          <div className="bg-white border border-gray-100 rounded-lg p-8 md:p-12 prose prose-lg max-w-none">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mt-10 mb-4">30-Day Return Window</h2>
            <p className="mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mt-10 mb-4">Free Return Shipping</h2>
            <p className="mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mt-10 mb-4">How to Return</h2>
