...
import { Star, Package, Tag, Clock, Calendar, CheckCircle, ArrowLeft, Loader2 } from "lucide-react";
                        ...
                        <Card>
                            ...
                            <CardContent>
                                ...
                                {product.category.slug && (
                                    <p className="text-sm text-muted-foreground mt-1">Slug: {product.category.slug}</p>
                                )}
                            </CardContent>
                        </Card>
                    )}
