...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-white text-slate-900 selection:bg-slate-950 selection:text-white">
      ...
      {/* 1. HERO / PAGE HEADER */}
      <PageHeader
        subtitle="About Our Store"
        title="Premium Apple Gear. Unbeatable Prices."
        description="Welcome to iPlug, your ultimate online marketplace for authenticated, brand-new and pristine mint-condition Apple devices. We skip the traditional retail markups to bring you the best deals on the hardware you love."
      />
